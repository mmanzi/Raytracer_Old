...
public class Scene1 extends World{
	...
	protected void build(Tracer t){
		...
		//Add objects
		Material redMat = new MirrorPhongMaterial(new RGBColor(0.5f, 0.5f, 1.f), new RGBColor(0.2f, 0.2f, 0.2f), new RGBColor(1.0f, 0.2f, 0.2f), 300.f,0.5f,t);
	...
	//	Material redMat = new DiffuseMaterial(new RGBColor(1.f, 0.5f, 0.5f));
		...
		Material blueMat = new MirrorPhongMaterial(new RGBColor(0.5f, 1.f, 0.5f), new RGBColor(0.2f, 0.2f, 0.2f), new RGBColor(1.0f, 0.2f, 1.0f), 300.f,0.5f,t);
